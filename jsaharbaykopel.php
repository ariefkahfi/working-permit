...
<tr bgcolor='aquamarine'>
    ...
    <tr>
		...
		<td rowspan="1" colspan="4">Kegiatan bertujuan untuk memeriksa kondisi peralatan gardu induk terkini  dalam kondisi tanpa padam dengan melakukan pengukuran dan pengujian  sehingga didapatkan data yang akan digunakan sebagai dasar 
		assesment pada PMT secara bertegangan.<br>
		</tr>
    <tr>
    ...
    <tr>
        <td rowspan="1" colspan="4">-Insulation Tester  -Stick Ground  -Tangga<br>-Resistance Contact Meter  -Multi Tester  -Steger<br>-Circuit Breaker Analyzer  -Tool Set + Kunci  -Voltage detector<br>-CT Analyzer  -Material : Kain majun + Pembersih</td>
    ...
    <tr>
        <td rowspan="1">4</td>
		<td rowspan="1">Pengujian dan pengukuran peralatan(PMT,CT,PMS)</td>
    ...
    <tr>
		 ...
		 <td colspan="3"></td>
		 <td rowspan="3" colspan="1"><img src="img/harkopel.jpg"></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><br>Syarhil Anwar<b></b></td>
