...
<tr bgcolor='aquamarine'>
	...
	<tr>
		...
		<td rowspan="1" colspan="4">Kegiatan bertujuan untuk memeriksa kondisi peralatan gardu induk terkini  dalam kondisi padam dengan melakukan pengukuran dan pengujian  sehingga didapatkan data yang akan digunakan sebagai dasar 										
				assesment pada LA secara bertegangan.</tr>
    <tr>
    ...
    <tr>
        <td rowspan="1" colspan="4">-Alat uji arus bocor</td>
    ...
    <tr>
        <td rowspan="1">3</td>
		<td rowspan="1">Pengujian dan pengukuran peralatan (LA)</td>
        <td>Terkena induksi</td>
        <td>Helm, Sepatu safety, Wearpack</td>
		<td>Memperhatikan posisi pada saat pengukuran<hr>Mengerti daerah dan jarak aman pada saat pengukuran</td>
    ...
    <tr>
		 ...
		 <td colspan="3">
		 <td rowspan="3" colspan="1"><img src="img/harlcm.jpg"></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><br><b></b></td>
