...
<span class="masuk_alinea">&nbsp;</span><table width="800px" border="10" >
    <tr>
        ...
        <td colspan="2"><img src="img/logo1.jpg" style="float:left;">
          <b>PT PLN (Persero) <br> P3B Sumatera</b>
        </td>
    ...
    <tr>
		...
		<td rowspan="1" colspan="4">Kegiatan dilakukan dengan cara membebani batere secara kontiyu sebesar 0,2 X Kapasitas betere,sehingga bisa di ketahui kemampuan batere secara nyata  <br>
		</tr>
    <tr>
    ...
    <tr>
        <td rowspan="1" colspan="4">-Dumyload  -Transformer Test Set<br>-Kain Majun+Pembersih<br>-Multi tester</td>
		<td rowspan="1" colspan="4">-Helm<br>-Sepatu Safety<br>-Wearpack</td>
	</tr>
    <tr>
    ...
    <tr>
        <td rowspan="1">3</td>
		<td rowspan="1">Manuver beban DC</td>
        <td>Terkena Tegangan DC</td>
        <td>Helm, Sepatu safety, Wearpack</td>
		<td>Melakukan manuver beban dc sehingga tidak menggangu sistem </td>
	</tr>
    <tr>
        <td rowspan="1">4</td>
		<td rowspan="1">Pengujian dan pengukuran peralatan</td>
        <td>Terjatuh<hr>Terkena Tegangan DC</td>
        <td>Helm, Sepatu safety, Wearpack</td>
		<td>Melakukan pengujian dengan cara memberi arus 0,2 X kapasitas batere<hr>Grounding lokal</td>
	</tr>
    <tr>
        <td rowspan="1">5</td>
		<td rowspan="1">Membersikan, merapikan kembali peralatan dan sistem</td>
        <td>Terkena Tegangan DC</td>
        <td>Helm, Sepatu safety, Wearpack</td>
		<td>Merapikan kembali semua dan mengembalikan sistem DC</td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Dibuat Oleh : <br> Pengawas Pekerjaan<br><br><br><br><br><br><b>M. Fikri</b></td>
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><b><br>Hendi.P</b></td>
