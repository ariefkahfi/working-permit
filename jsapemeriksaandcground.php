...
<tr bgcolor='aquamarine'>
    ...
    <tr>
		...
		<td rowspan="1" colspan="4">Kegiatan dilakukan dengan cara membebani batere secara kontiyu sebesar 0,2 X Kapasitas betere,sehingga bisa di ketahui kemampuan batere secara nyata  </tr>
    <tr>
    ...
    <tr>
        <td rowspan="1" colspan="4">-Dumyload<hr>-Kain majun+Pembersih<br>Multi tester</td>
    ...
    <tr>
        ...
        <td>Terkena tegangan DC</td>
        <td>Helm, Sepatu safety, Wearpack</td>
		<td>Melakukan manover beban dc sehingga tidak mengganggu sistem</td>
	</tr>
    <tr>
        <td rowspan="1">4</td>
    ...
    <tr>
        <td rowspan="1">5</td>
		<td rowspan="1">Membersihkan, merapikan kembali peralatan dan sistem</td>
        <td>Terkena tegangan DC</td>
        <td>Helm, Sepatu safety, Wearpack6</td>
    ...
    <tr>
        ...
        <td>Dibuat Oleh : <br> Pengawas Pekerjaan<br><br><br><br><b>Fandi A.S</b></td>
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><br><b>Hendi.P</b></td>
