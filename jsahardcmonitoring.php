...
<tr bgcolor='aquamarine'>
        <td colspan="2"><img src="img/logo1.jpg" style=”float:left;"/><b>PT PLN (Persero) <br> P3B Sumatera</b></td>
    ...
    <tr>
        ...
        <td colspan="2"><b>20 Januari 2015</b></td>
    </tr>
		<tr bgcolor='aquamarine'>
        <td><b>Halaman<b></td>
    ...
    <tr>
        <td colspan="6" rowspan="1" id="content_surat"></div></td>
	</tr>
    <tr>
        <td><b>Deskripsi Pekerjaan</b></td>
		<td rowspan="1" colspan="4">Kegiatan bertujuan untuk memeriksa kondisi peralatan gardu induk terkini  dalam kondisi padam dengan melakukan pengukuran dan pengujian  sehingga didapatkan data yang akan digunakan sebagai dasar 									
		assesment, melakukan pembersihan isolator peralatan sehingga nilai isolasinya terjaga serta melakukan pengencangan dan penggantian mur baut  pada konektor antara konduktor dan peralatan untuk 									
		mengurangi potensi hotspot pada konektor.</tr>
    <tr>
    ...
    <tr>
        <td rowspan="1">3</td>
		<td rowspan="1">Melakukan pemasangan DC Monitoring pada kubikel incoming Trafo</td>
        <td>Terkena tegangan<hr>Terjatuh<Terkena alat potong/bor</td>
        <td>Helm, Sepatu safety, Wearpack,kacamata</td>
		<td>Melakukan pekerjaan sesuai dengan SOP dan selalu utamakan keselamatan</td>
	</tr>
    <tr>
        <td rowspan="1">4</td>
		<td rowspan="1">Melakukan simulasi dari DC Monitoring</td>
        <td>Terkena tegangan</td>
        <td>Helm, Sepatu safety, Wearpack,kacamata</td>
		<td>Melakukan pekerjaan sesuai dengan SOP dan selalu utamakan keselamatan</td>
	</tr>
    <tr>
        <td rowspan="1">5</td>
		<td rowspan="1">Merapikan kembali peralatan dan lokasi pekerjaan</td>
        <td>Terkena tegangan</td>
        <td>Helm, Sepatu safety, Wearpack,kacamata</td>
		<td>Melakukan briefing pekerjaan selesai dan melakukan evaluasi untuk perbaikan pada pekerjaan selanjutnya</td>	
	</tr>
    <tr>
    ...
    <tr>
		 ...
		 <td colspan="3">
		 <td rowspan="3" colspan="1"><img src="img/hardcmonitoring.jpg"></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Dibuat Oleh : <br> Pengawas Pekerjaan<br><br><br><br><b>Yoni Purwanto</b></td>
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><br><b>Junaidi/Syahril Anwar</b></td>
		<td>Disetujui: <br> Penanggung Jawab Pekerjaan <br><br><br><br><b>Ardiansyah</b></td>
	</tr>
    <tr>
