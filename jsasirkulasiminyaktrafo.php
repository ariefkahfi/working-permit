...
mengurangi potensi hotspot pada konektor.										
<tr>
    ...
    <tr>
        <td rowspan="1" colspan="4">-Mobil Sirkulasi Minyak</td>
		<td rowspan="1" colspan="4">-Helm<br>-Sepatu Safety<br>-Wearpack<br>-Sarung Tangan</td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Insuksi Tegangan di Switch Yard</td>
        <td>Helm, Sepatu safety, Wearpack</td>
    ...
    <tr>
        <td rowspan="1">3</td>
		<td rowspan="1">Menginstal Selang Minyak</td>
        <td>Terkena tegangan Busbar di Switch Yard</td>
        <td>Helm, Sepatu safety, Wearpack, Sarung Tangan</td>
		<td>"Melakukan pemasangan selang minyak pada trafo tanpa padam<hr>Memastikan koneksi selang dalam keadaan kencang
	</td>
	</tr>
    <tr>
        <td rowspan="1">4</td>
		<td rowspan="1">Melakukan Pengujian Secara Online</td>
        <td>Terkena minyak<hr>Terkena Tegangan</td>
        <td>Helm, Sepatu safety, Wearpack, Sarung Tangan</td>
		<td>Memastikan keadaan Mobil Sirkulasi berjalan normal
	</tr>
    <tr>
    ...
    <tr>
		 ...
		 <td colspan="3">
		 <td rowspan="3" colspan="1"><img src="img/harsirkulasiminyak.jpg"></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td>Dibuat Oleh : <br> Pengawas Pekerjaan<br><br><br><br><b>Sukahar Trisunu</b></td>
        <td>Diperiksa : <br> Pengawas K3 <br><br><br><br><br><br><b>M. Fikri</b></td>
		<td>Disetujui: <br> Penanggung Jawab Pekerjaan <br><br><br><br><b>Ramlan Sulaeman</b></td>
	</tr>
    <tr>
